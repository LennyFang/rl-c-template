...
case $1 in # First arg is os
    ...
    "mac")
        OS=MAC
        clang -DOS -Wall -Og -framework CoreVideo -framework IOKit -framework Cocoa -framework GLUT -framework OpenGL ./src/platform/macos_platform.c ./src/vendor/raylib/mac/libraylib.6.0.0.dylib -Wl,-rpath,./src/vendor/raylib/mac -o ./bin/main.bin
        ;;

    "windows")
        OS=WINDOWS
        gcc -DOS -Wall -Og src/platform/win32_platform.c ./src/vendor/raylib/windows/raylib.dll -lgdi32 -lwinmm -Wl,-rpath,./src/vendor/raylib/windows -o ./bin/main.bin
        ;;
    *)
